...
export const onRequest = vercelOGPagesPlugin({
	imagePathSuffix: "/og-image-intro.png",
	component: () => {
		const { backgroundColor, color } = OG_COLOR_MAPPING.default;
		...
		return new ImageResponse(
			...
			>
				...
				<div style={{ marginTop: 40 }}>Connect to Core ID via CorePass</div>
				<div style={{ marginTop: 20, fontSize: 30, fontWeight: 400, letterSpacing: 2.5 }}>
					Connect with the CorePass community.
				</div>
			</div>,
			{
				width: 1200,
